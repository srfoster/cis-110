...
> We can open and close our switch and it would manipulate the numbers that um come out which represent **binary** digits.
...
> And can you still see if I move that up? Um, yes.
> Okay.
...
> It's not um it's simple to to use and **electricity** can can use with it.
> Okay.
...
> Okay.
> **HTML** is the code used to write um web pages.
...
> Um, through email um I don't this is a later topic but um through **spoofing** they posed as a company that we work with on a regular basis and requested um payment for services that we are we're paying that company for.
...
> Okay.
> Um so we got **magnetic** um **optical** and **solid state**.
> Um **magnetic** would be like um a **hard drive**.
> Um they are mechanical so they can wear out.
> Um, so that would be I guess a negative.
> Um, they are rewritable, so that's a positive.
> Um, there is no burning involved, so it's it's more um reusable than its counterparts of like **optical**.
> Um, **optical** **optical** is kind of like a **CD** drive.
> It's essentially when things like um colors or um **lasers**.
> They go and they they write discs, right? So, it's **optical** like visual.
> Um it is done through burning.
...
> I think img.
> Uh I think it's img.
> And this would be image.
> It would display your image.
> And then a you could insert a hyperlink.
...
> Okay.
> Okay.
> So the bones are the structure.
> The **JavaScript** is like the interactive portion of your um your website.
> So like **buttons** you can click um right here your your canvas button or clear button um your next button **JavaScript** or things that you can interact with and move online.
> And then **CSS** is the styling components um of the web page.
> So components components I'm glad this is not a spelling class but um it's components right it's your styling components so like the fact that this color I think you mentioned is blue is **CSS** or um this heading is probably **CSS** the shape of it and the way that you designed it.
> Um okay next question.
...
> Okay.
> Next question.
> Explain what IO devices are and why they
...
> page.
> Um, I've written this a few times tonight, but so the **HTML**, **JavaScript**, and **CSS** all work together to create a web page.
> The **HTML** is the bones or the structure of the web page.
> the **JavaScript** what you're asking about is the interactive portion of your web page.
> So like **buttons** um places that you can move or um interact with on the um on the web page.
> And then **CSS** is the styling component, how your you know your colors and and what um and how that's formed.
> Um, so they all work together to create a web page, but **JavaScript** is just the the interacted the interaction here, but it's the interactive portions.
> And then next question, discuss issues with creating a strong
